/**
 * @file src/components/GameSystemLogos.tsx
 * This file acts as a library of SVG logo components for various game systems.
 * Each logo is a simple, stateless React functional component.
 */

import React from 'react';

/**
 * A wrapper component to provide a consistent `viewBox` and base styling for all logos.
 * @param {React.ReactNode} children The SVG path data for the specific logo.
 * @returns {JSX.Element} The complete SVG element.
 */
...
// Each export below is a specific logo component.
// They use the SvgWrapper to avoid repeating boilerplate SVG code.

export const Warhammer40kLogo: React.FC = () => (
    <SvgWrapper>
        {/* Imperial Aquila inspired design */}
...
export const AgeOfSigmarLogo: React.FC = () => (
    <SvgWrapper>
        {/* Sigmar's Comet inspired design */}
...
export const OldWorldLogo: React.FC = () => (
    <SvgWrapper>
        {/* Hammer and shield inspired design */}
...
export const StarWarsLegionLogo: React.FC = () => (
    <SvgWrapper>
        {/* Rebel Alliance Starbird inspired design */}
...
export const ShatterpointLogo: React.FC = () => (
    <SvgWrapper>
        {/* Abstract crystal/shatter design */}
...
export const MarvelCrisisProtocolLogo: React.FC = () => (
    <SvgWrapper>
        {/* Simple text logo, reflecting the game's branding */}
...
export const MiddleEarthSBGLogo: React.FC = () => (
    <SvgWrapper>
        {/* White Tree of Gondor inspired design */}
...
export const GenericSciFiLogo: React.FC = () => (
    <SvgWrapper>
        {/* A generic logo for sci-fi games without a specific icon */}
...
export const GenericFantasyLogo: React.FC = () => (
    <SvgWrapper>
        {/* A generic logo for fantasy games without a specific icon */}
